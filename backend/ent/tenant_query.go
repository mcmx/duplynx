...
type TenantQuery struct {
	...
	withScans           *ScanQuery
	withDuplicateGroups *DuplicateGroupQuery
...
func (_q *TenantQuery) QueryMachines() *MachineQuery {
...
func (_q *TenantQuery) QueryScans() *ScanQuery {
...
// QueryDuplicateGroups chains the current query on the "duplicate_groups" edge.
func (_q *TenantQuery) QueryDuplicateGroups() *DuplicateGroupQuery {
...
func (_q *TenantQuery) QueryActionAudits() *ActionAuditQuery {
...
func (_q *TenantQuery) Clone() *TenantQuery {
	...
	return &TenantQuery{
		...
		withDuplicateGroups: _q.withDuplicateGroups.Clone(),
...
func (_q *TenantQuery) WithMachines(opts ...func(*MachineQuery)) *TenantQuery {
	query := (&MachineClient{config: _q.config}).Query()
...
func (_q *TenantQuery) WithScans(opts ...func(*ScanQuery)) *TenantQuery {
	query := (&ScanClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithDuplicateGroups tells the query-builder to eager-load the nodes that are connected to
// the "duplicate_groups" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *TenantQuery) WithDuplicateGroups(opts ...func(*DuplicateGroupQuery)) *TenantQuery {
	query := (&DuplicateGroupClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withDuplicateGroups = query
	return _q
}
...
func (_q *TenantQuery) WithActionAudits(opts ...func(*ActionAuditQuery)) *TenantQuery {
	query := (&ActionAuditClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *TenantQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Tenant, error) {
	...
	if query := _q.withMachines; query != nil {
		if err := _q.loadMachines(ctx, query, nodes,
			func(n *Tenant) { n.Edges.Machines = []*Machine{} },
			func(n *Tenant, e *Machine) { n.Edges.Machines = append(n.Edges.Machines, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withScans; query != nil {
		if err := _q.loadScans(ctx, query, nodes,
			func(n *Tenant) { n.Edges.Scans = []*Scan{} },
			func(n *Tenant, e *Scan) { n.Edges.Scans = append(n.Edges.Scans, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withDuplicateGroups; query != nil {
		if err := _q.loadDuplicateGroups(ctx, query, nodes,
			func(n *Tenant) { n.Edges.DuplicateGroups = []*DuplicateGroup{} },
			func(n *Tenant, e *DuplicateGroup) { n.Edges.DuplicateGroups = append(n.Edges.DuplicateGroups, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withActionAudits; query != nil {
		if err := _q.loadActionAudits(ctx, query, nodes,
			func(n *Tenant) { n.Edges.ActionAudits = []*ActionAudit{} },
			func(n *Tenant, e *ActionAudit) { n.Edges.ActionAudits = append(n.Edges.ActionAudits, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *TenantQuery) loadMachines(ctx context.Context, query *MachineQuery, nodes []*Tenant, init func(*Tenant), assign func(*Tenant, *Machine)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(machine.FieldTenantID)
	}
	query.Where(predicate.Machine(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(tenant.MachinesColumn), fks...))
	}))
...
func (_q *TenantQuery) loadScans(ctx context.Context, query *ScanQuery, nodes []*Tenant, init func(*Tenant), assign func(*Tenant, *Scan)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Tenant)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(scan.FieldTenantID)
	}
	query.Where(predicate.Scan(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(tenant.ScansColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *TenantQuery) loadDuplicateGroups(ctx context.Context, query *DuplicateGroupQuery, nodes []*Tenant, init func(*Tenant), assign func(*Tenant, *DuplicateGroup)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Tenant)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(duplicategroup.FieldTenantID)
	}
	query.Where(predicate.DuplicateGroup(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(tenant.DuplicateGroupsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *TenantQuery) loadActionAudits(ctx context.Context, query *ActionAuditQuery, nodes []*Tenant, init func(*Tenant), assign func(*Tenant, *ActionAudit)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Tenant)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(actionaudit.FieldTenantID)
	}
	query.Where(predicate.ActionAudit(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(tenant.ActionAuditsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
